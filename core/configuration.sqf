...
life_cash = 0;
life_impound_car = 2000;
life_impound_boat = 3000;
life_impound_air = 5000;
life_istazed = false;
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",2500],["methu",400],["methp",4000],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",3000],["moonshine",650]];
