...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["texture\offroad_police.jpg","cop"],
			...
			["texture\offroad_depannage.jpg","civ"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["texture\suv_noir.jpg","civ"],
			["texture\suv_blanc.jpg","civ"],
			["texture\suv_nb2.jpg","civ"],
			["texture\suv_nb.jpg","civ"],
			["texture\suv_rouge.jpg","civ"],
	...
	case "B_MRAP_01_F":
	{
		_ret = 
		[
			["texture\mrap_police_noir.jpg","cop","texture\mrap_police_noir_adds.jpg"],
